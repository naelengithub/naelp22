export const webProjects = [
  ...
  },
  {
    ...
    images: [
      ...
      {
        category: "About Page",
        sources: ["/dr-pablo-lopez/about-desktop.png"],
      },
      {
        category: "Example Case",
        sources: ["/dr-pablo-lopez/caso_ejemplo-dktp.png"],
      },
      {
        category: "Procedures Page",
        sources: ["/dr-pablo-lopez/Procedimientos-dktp.png"],
      },
      {
  ...
  },
  {
    ...
    images: [
      { category: "home", sources: ["/clp/Homepage-dktp.jpg"] },
      {
        ...
        sources: ["/clp/primaria-dktp.png"],
      },
      {
        category: "events",
        sources: ["/clp/Eventos-dktp.png"],
      },
      {
